<script setup>
import safeBoxWithGoldenCoin from '@app/assets/images/misc/3d-safe-box-with-golden-dollar-coins.png'
import spaceRocket from '@app/assets/images/misc/3d-space-rocket-with-smoke.png'
import dollarCoinPiggyBank from '@app/assets/images/misc/dollar-coins-flying-pink-piggy-bank.png'
