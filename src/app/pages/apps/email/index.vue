...
import ComposeDialog from '@app/views/apps/email/ComposeDialog.vue'
import EmailLeftSidebarContent from '@app/views/apps/email/EmailLeftSidebarContent.vue'
import EmailView from '@app/views/apps/email/EmailView.vue'
import { useEmail } from '@app/views/apps/email/useEmail'
